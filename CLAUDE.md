...
| `update-ubuntu.sh` | Bash | Normal user | Maintenance-only refresh: apt upgrade plus starship, zoxide, git-delta, lazygit, stern, aspire, k9s, kubectx, npm globals, pipx tools. `--skip-*` flags opt out |
